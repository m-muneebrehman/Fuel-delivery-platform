...
export default function FuelDeliverySystem() {
  ...
  const locations = [
    { id: 1, name: "F-8 Markaz", address: "123 Jinnah Avenue, F-8 Markaz, Islamabad" },
    { id: 2, name: "Blue Area", address: "45 Blue Area, Islamabad" },
    { id: 3, name: "I-8 Markaz", address: "78 Main Commercial, I-8 Markaz, Islamabad" },
  ...
  const dummyOrderData = {
    ...
    fuelType: fuelType,
    quantity: quantity,
    price: fuelType === "Petrol" ? 272.89 : fuelType === "Diesel" ? 278.91 : 210.30,
    deliveryFee: 150,
  ...
  const createOrder = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/fuel-orders`, {
        method: 'POST',
        headers: {
  ...
  const onPlaceSelected = async () => {
    if (searchBox) {
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_API_URL}/fuel-orders/nearby-pumps?location=${JSON.stringify(location)}&radius=5000`, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                <CreditCard size={20} className={`mr-2 ${paymentMethod === 'card' ? 'text-red-600' : 'text-gray-400'}`} />
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                <Home size={20} className={`mr-2 ${paymentMethod === 'cash' ? 'text-red-600' : 'text-gray-400'}`} />
          ...
          {showTracking ? (
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-3xl mx-auto">
              {currentOrder ? (
                <>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      ...
                      {currentOrder.status === 'delivered' ? 'Delivered' : 'In Progress'}
                    </span>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200">
                    <div className="flex items-start">
                      <div className={`p-3 rounded-full mr-4 ${
                        ...
                        {currentOrder.status === 'delivered' ? <Check size={24} /> : <Truck size={24} />}
                      </div>
                      <div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 mb-6">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-start mb-4">
                        ...
                        <div>
                          <p className="font-medium text-gray-800">Order Date & Time</p>
                          <p className="text-gray-600">
                            {new Date(currentOrder.createdAt).toLocaleDateString()}, {formatTime(currentOrder.createdAt)}
                          </p>
                        </div>
                      </div>
                      
                      <div className="flex items-start">
                        <Fuel size={20} className="text-gray-400 mr-3 mt-1 flex-shrink-0" />
                        <div>
                          <p className="font-medium text-gray-800">Fuel Details</p>
                          <p className="text-gray-600">
                            {currentOrder.quantity} liters of {currentOrder.fuelType}
                          </p>
                          <p className="text-gray-600">
                            Rs. {(currentOrder.price * currentOrder.quantity + currentOrder.deliveryFee).toFixed(2)}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {currentOrder.status !== 'delivered' && (
                    <div className="bg-white rounded-lg border border-gray-200 mb-6">
                      <div className="border-b border-gray-200 p-4">
                        <h3 className="font-bold text-gray-800">Delivery Partner</h3>
                      </div>
                      ...
                      <div className="p-4 flex items-center">
                        ...
                        <div className="flex-grow">
                          <p className="font-medium text-gray-800">{currentOrder.driver.name}</p>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div className="h-64 bg-gray-200 relative">
                      <img src="/bg-car.jpg" alt="Map view" className="w-full h-full object-cover" />
                      ...
                      {/* Vehicle Icon */}
                      <div className="absolute" style={{ 
                        left: `${20 + (80 - 20) * (currentOrder.tracking.progress / 100)}%`, 
                        top: `${60 - (60 - 30) * (currentOrder.tracking.progress / 100)}%`,
                        transform: 'translate(-50%, -50%)'
                      }}>
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-600 mb-6">You don't have any active fuel delivery orders to track.</p>
                  <button 
                    onClick={() => setShowTracking(false)}
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-red-600 to-red-800 text-white rounded-lg shadow-lg mb-8 overflow-hidden">
                <div className="md:flex items-center">
                  <div className="p-6 md:w-1/2">
                    <h2 className="text-3xl font-bold mb-4">On-Demand Fuel Delivery</h2>
                    <p className="mb-6">Get fuel delivered directly to your vehicle or home storage tank in Islamabad.</p>
                  ...
                  <div className="md:w-1/2 h-64 bg-gray-300">
                    <img src="/api/placeholder/640/320" alt="Fuel delivery truck" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 max-w-3xl mx-auto">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Order Fuel</h2>
                ...
                <div className="mb-8">
                  ...
                  <div className="flex justify-between mt-2 text-sm text-gray-600">
                    <span className={activeStep === 1 ? 'font-medium text-red-600' : ''}>Fuel Selection</span>
                    <span className={activeStep === 2 ? 'font-medium text-red-600' : ''}>Delivery Location</span>
                    <span className={activeStep === 3 ? 'font-medium text-red-600' : ''}>Payment</span>
                  </div>
                </div>
                ...
                {activeStep === 1 && (
                  <div>
                    <h3 className="font-bold text-lg text-gray-800 mb-4">Select Fuel Type & Quantity</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      {['Petrol', 'Diesel', 'CNG'].map(fuel => (
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center">
                              <Fuel size={20} className={`mr-2 ${fuelType === fuel ? 'text-red-600' : 'text-gray-400'}`} />
                          ...
                          <div className="text-sm text-gray-600">
                            Current Price: Rs. {fuel === 'Petrol' ? '272.89' : fuel === 'Diesel' ? '278.91' : '210.30'}/liter
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                {activeStep === 2 && (
                  <div>
                    <h3 className="font-bold text-lg text-gray-800 mb-4">Delivery Location</h3>
                    ...
                    {selectedLocation && (
                      <div className="mb-6">
                        <h4 className="font-medium text-gray-800 mb-2">Nearby Fuel Pumps</h4>
                        {isLoadingPumps ? (
                          <div className="text-center py-4">
                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-red-600 mx-auto"></div>
                            <p className="mt-2 text-gray-600">Finding nearby fuel pumps...</p>
                          </div>
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            {nearbyPumps.map((pump) => (
                              <div 
                                ...
                                onClick={() => setAddress(pump.address)}
                              >
                                <div className="flex items-center justify-between mb-1">
                                  <div className="flex items-center">
                                    <MapPin size={18} className={`mr-2 ${address === pump.address ? 'text-red-600' : 'text-gray-400'}`} />
                                    <span className="font-medium">{pump.name || 'Fuel Station'}</span>
                                  </div>
                                  <div className={`w-4 h-4 rounded-full border ${
                                    address === pump.address
                                      ? 'border-red-600 bg-red-600'
                                ...
                                <p className="text-sm text-gray-600 mt-1">{pump.address}</p>
                                {pump.distance && (
                                  <p className="text-sm text-gray-500 mt-1">
                                    Distance: {(pump.distance / 1000).toFixed(1)} km
                                  </p>
                                )}
                              </div>
                            ))}
                          ...
                          <div className="text-center py-4 bg-gray-50 rounded-lg">
                            <p className="text-gray-600">No fuel pumps found within 5km radius</p>
                          </div>
                        )}
                      </div>
                    )}
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200">
                      <h4 className="font-medium text-gray-800 mb-2">Delivery Notes</h4>
                      <textarea
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <p className="text-gray-600">Get fuel delivered to your location in Islamabad within 45 minutes.</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <p className="text-gray-600">We source our fuel only from authorized dealers to ensure highest quality.</p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <p className="text-gray-600">Pay securely with your credit/debit card or choose cash on delivery.</p>
                </div>
              </div>
              ...
              <div className="mt-12 bg-white rounded-lg shadow-lg p-6 md:p-8">
                ...
                <div className="mb-4">
                  <h3 className="font-bold text-gray-800 mb-2">How does fuel delivery work?</h3>
                  <p className="text-gray-600">We deliver fuel directly to your location in specialized fuel trucks. Just place an order, and our trained professionals will deliver fuel to your vehicle or storage tank.</p>
                </div>
                
                <div className="mb-4">
                  <h3 className="font-bold text-gray-800 mb-2">What areas do you serve in Islamabad?</h3>
                  <p className="text-gray-600">We currently serve all major sectors in Islamabad including F sectors, G sectors, I sectors, and Blue Area.</p>
                </div>
                
                <div className="mb-4">
                  <h3 className="font-bold text-gray-800 mb-2">Is there a minimum order quantity?</h3>
                  <p className="text-gray-600">Yes, our minimum order quantity is 5 liters to ensure delivery efficiency.</p>
                </div>
                
                <div>
                  <h3 className="font-bold text-gray-800 mb-2">How can I track my fuel delivery?</h3>
                  <p className="text-gray-600">Once your order is confirmed, you can track your delivery in real-time through our app's tracking feature.</p>
                </div>
              </div>
            </div>
          )}
